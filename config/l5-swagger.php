...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => [
                'title' => 'Google Analytics API Documentation',
            ],
            'routes' => [
                /*
    ...
    'defaults' => [
        ...
        'scanOptions' => [
            ...
            /**
             * pattern: defaults to a reasonable default based on the processor type .
             *
             * @see \OpenApi\scan
             */
            'pattern' => null,
        ...
        */
         ...
         * See more at: https://swagger.io/docs/open-source-tools/swagger-ui/usage/configuration/#configs-plugin
        */
        ...
        */
         ...
         */
        'constants' => [
            'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'https://analytics-dashboard.up.railway.app//api'),
        ],
    ],
];